...
Once the key ceremony is completed, delete all existing addresses out of DataBase (provide instructions).
Next, generate a set of addresses (insert link where that is explained in the manual) and write them down publicly.
